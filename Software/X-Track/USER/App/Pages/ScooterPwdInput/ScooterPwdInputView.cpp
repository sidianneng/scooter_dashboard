...
void ScooterPwdInputView::Create(lv_obj_t* root)
{
...
lv_obj_t* ScooterPwdInputView::Pwd_Textarea_Create(lv_obj_t* root)
{
...
lv_obj_t* ScooterPwdInputView::Pwd_Keyboard_Create(lv_obj_t* root)
{
